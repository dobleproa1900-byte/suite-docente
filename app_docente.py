    ...
    with tab1:
        ...
        with col_preview:
            ...
            if ejecutar:
                ...
                elif client is None or "TU_API_KEY" in client.api_key:
                    st.error("❌ API Key de Groq no detectada. Colocá tu gsk_ real en la línea 25.")
                else:
        ...
        with col_acta_out:
            ...
            if procesar_acta:
                if not texto_crudo:
                    ...
                    st.error("❌ API Key de Groq no detectada.")
                else:
